...
export function match<T, E>(
...
): MatchFunc<T, E | PatternrevealDefaultError | ResponseValidationError> {
  return async function matchFunc(
    ...
    [
      result: Result<
        T,
        E | PatternrevealDefaultError | ResponseValidationError
      >,
      raw: unknown,
    ]
  > {
    ...
    if (!matcher) {
      return [{
        ok: false,
        error: new PatternrevealDefaultError(
    ...
    if (matcher.enc === "fail") {
      return [{
        ok: false,
        error: new PatternrevealDefaultError("API error occurred", {
          request,
          response,
          body,
        }),
