...
const patternrevealdefaulterror_js_1 = require("../models/errors/patternrevealdefaulterror.js");
...
function match(...matchers) {
    return async function matchFunc(response, request, options) {
        ...
        if (!matcher) {
            return [{
                    ok: false,
                    error: new patternrevealdefaulterror_js_1.PatternrevealDefaultError("Unexpected Status or Content-Type", {
                        response,
                        request,
        ...
        if (matcher.enc === "fail") {
            return [{
                    ok: false,
                    error: new patternrevealdefaulterror_js_1.PatternrevealDefaultError("API error occurred", {
                        request,
                        response,
                        body,
                    }),
