...
class ClientSDK {
    constructor(options = {}) {
        ...
        if (!__classPrivateFieldGet(this, _ClientSDK_logger, "f") && (0, env_js_1.env)().PATTERNREVEAL_DEBUG) {
    ...
    _createRequest(context, conf, options) {
        ...
        const encodeQueryRecord = (record) => {
            return Object.entries(record)
                ...
                const value = v;
                return (0, encodings_js_1.encodeForm)(k, value, {
    ...
    async _do(request, options) {
        ...
        return (0, retries_js_1.retry)(async () => {
            ...
            if (timeoutMs != null && timeoutMs > 0) {
                ...
                const combined = (0, primitives_js_1.combineSignals)(cloned.signal, timeoutSignal)
                    ?? timeoutSignal;
