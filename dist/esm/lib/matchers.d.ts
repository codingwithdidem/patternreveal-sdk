import { PatternrevealDefaultError } from "../models/errors/patternrevealdefaulterror.js";
...
export declare function match<T, E>(...matchers: Array<Matcher<T, E>>): MatchFunc<T, E | PatternrevealDefaultError | ResponseValidationError>;
/**
